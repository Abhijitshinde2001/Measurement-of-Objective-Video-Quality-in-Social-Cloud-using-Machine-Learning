...
root.title("Video Quality measurement")

current_path = str(os.path.dirname(os.path.realpath('__file__')))

basepath=current_path  + "D:/100%video_quality/100%video_quality/video_quality" 
...
heading = tk.Label(root,text="Video Quality Measurment",width=25,font=("Times New Roman",45,'bold'),bg="#192841",fg="white")
...
def VIDEO():
    ...
    fn=""
    fileName = askopenfilename(initialdir='D:/100%video_quality/100%video_quality/video_quality/testing', title='Select image',
                               filetypes=[("all files", "*.*")])
...
def show_FDD_video(video_path):
    ...
    FALLModel=load_model('model.h5')    #video = cv.VideoCapture(video_path);
    ...
    while True:
        ...
        if  label == 1 :
            label_text = "Video Quality is PSNR .value is more than 60 dB or higher"
            color = green
          #mean squared error(MSE)...  
        else:
            label_text = "Video Quality is MSE...average of MSE is 0"
            color = red
...
button5 = tk.Button(root,command = Video_Verify, text="Quality Measurement", width=20,font=("Times new roman", 25, "bold"),bg="cyan",fg="black")
